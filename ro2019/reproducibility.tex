...
This requirement, referred to as the \emph{reproducibility} or \emph{replicability} of
	...
	under which these activities are carried out (\emph{temperatures},
...
In Section\,\ref{sec-repeatability} we will examine definitions of these terms jointly adopted by thirty research
...
For now we note that the notion of \emph{replicates}, repeated measurements made to quantify
	experimental variability, is represented by a rich literature~\cite{vaux_replicates_2012, robasky_role_2014}.
