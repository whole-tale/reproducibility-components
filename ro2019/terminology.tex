...
%    For experimental biologists, at least, the assignment of meanings to the terms
%     	\emph{reproducibility} and \emph{replicability} is neither arbitrary nor uninformed.
...
%These examples illustrate the diversity of reproducibility claims that can usefully be made about
...
%Similar procedures have been implemented by communities within the ACM
%    (e.g., \url{http://db-reproducibility.seas.harvard.edu},
%    \url{https://ctuning.org/ae/reviewing.html}).
%    , \textsf{ctuning::reproducible}, respectively.
%    and be  discoverable via \textsf{NAS::reproducible}.
%    The nascent practice of \emph{badging} publications with reproducible
%    artifacts
...
% PRIMAD came about from answering question of what we expect to learn from a reproducibility study anyways?
% When reproducibility succeeds, what is the information gain?  When it fails?
% To say anything we have to know how the reproducibility study compares to the original.
% Are they addressing the same goals?  Same algorithm?  Same implementation? Same platform?
% Largely or
