...
This aspect of the disagreement over terminologies is in a sense trivial\footnote{
	...
	We note, however, that both the high-fidelity \emph{replication} of DNA (in the \emph{replisome}~\cite{spenkelink_recycling_2019})
		...
		expected and desirable. For experimental biologists, at least, the assignment of meanings to the terms
     	\emph{reproducibility} and \emph{replicability} is neither arbitrary nor uninformed.}, although the NAS likely is correct in
...
By highlighting these aspects of the NAS definitions
...
Together we could then determine how various terms and definitions, that have
    been put forward to meet the needs of particular research communities,
