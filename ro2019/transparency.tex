...
Where a particular computed result is not \term{NAS::reproducible}, they could pose a query
...
Answers to such queries could take available technology for reproducing computations
	into account.
For example, a particular result might no longer be \term{NAS::reproducible} using the
